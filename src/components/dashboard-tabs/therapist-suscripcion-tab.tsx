...
import { createSubscriptionCheckout, openBillingPortal } from "@/app/dashboard/suscripcion/actions";
...
export type SuscripcionTabParams = {
  sus_ok?: string;
  sus_cancelado?: string;
  sus_error?: string;
};

export async function TherapistSuscripcionTab({ params }: { params: SuscripcionTabParams }) {
  const { sus_ok: ok, sus_cancelado: cancelado, sus_error: error } = params;
