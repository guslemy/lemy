...
export type DisponibilidadTabParams = {
  disp_guardado?: string;
  disp_eliminado?: string;
  disp_error?: string;
  disp_guardado_anticipacion?: string;
  disp_guardado_duracion?: string;
  disp_guardado_ventana_maxima?: string;
  disp_bloqueado?: string;
  disp_desbloqueado?: string;
};

export async function TherapistDisponibilidadTab({ params }: { params: DisponibilidadTabParams }) {
  const {
    disp_guardado: guardado,
    disp_eliminado: eliminado,
    disp_error: error,
    disp_guardado_anticipacion: guardado_anticipacion,
    disp_guardado_duracion: guardado_duracion,
    disp_guardado_ventana_maxima: guardado_ventana_maxima,
    disp_bloqueado: bloqueado,
    disp_desbloqueado: desbloqueado,
  } = params;
